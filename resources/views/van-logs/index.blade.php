<x-layouts.app>
    <x-slot name="header">Van Logs</x-slot>
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center gap-2">
            <flux:button variant="primary" icon="plus" wire:click="$dispatch('open-modal', { component: 'van-logs.create' })">
                Add Log
            </flux:button>
    ...
    <flux:table>
        <flux:table.columns>
            ...
            <flux:table.column>Start Mileage</flux:table.column>
            <flux:table.column>End Mileage</flux:table.column>
            <flux:table.column>Status</flux:table.column>
            <flux:table.column></flux:table.column>
        </flux:table.columns>
        <flux:table.rows>
            @foreach ($this->vanLogs as $log)
                <flux:table.row>
                    ...
                    <flux:table.cell>{{ number_format($log->start_mileage) }}</flux:table.cell>
                    <flux:table.cell>{{ number_format($log->end_mileage) }}</flux:table.cell>
                    <flux:table.cell>
                    ...
                    <flux:table.cell>
                        <flux:dropdown position="bottom" align="end" offset="-15">
                            ...
                            <flux:menu>
                                <flux:menu.item icon="eye" wire:click="$dispatch('open-modal', { component: 'van-logs.view', arguments: { log: {{ $log->id }} } })">
                                    View
                                </flux:menu.item>
                                <flux:menu.item icon="pencil" wire:click="$dispatch('open-modal', { component: 'van-logs.edit', arguments: { log: {{ $log->id }} } })">
                                    Edit
                                </flux:menu.item>
    ...
    <flux:pagination :paginator="$this->vanLogs" />
</x-layouts.app> 